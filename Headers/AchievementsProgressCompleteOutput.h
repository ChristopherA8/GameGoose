...
@interface AchievementsProgressCompleteOutput : NSObject <ProtobufMessage>
{
    int cachedSize;
    int cachedSizeId;
    _Bool completedNow;
...
+ (id)achievementsProgressCompleteOutputWithAchievement:(id)arg1 completedNow:(_Bool)arg2;
