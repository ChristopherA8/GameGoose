...
@class ActionButton, AvatarNode, BeerCustomizeItem, MessagesViewController, NSMutableArray, SKCropNode, SKLabelNode, SKMultilineLabel, SKNode, SKSpriteNode;

@interface BeerCustomizeScene : SKScene
{
