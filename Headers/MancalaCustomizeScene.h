...
@class ActionButton, AvatarNode, MessagesViewController, SKCropNode, SKLabelNode, SKMultilineLabel, SKNode, SKSpriteNode;

@interface MancalaCustomizeScene : SKScene
{
    _Bool premium;
    SKSpriteNode *black;
