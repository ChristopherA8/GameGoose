...
@class ActionButton, BasketballBall, BeerView, GoalNode, GolfBall, GolfCounter, GolfZoomButton, NSDate, NSMutableArray, NSMutableString, NSString, NSTimer, PoolSkipButton, SCNNode, SCNPhysicsBody, SCNScene, SK3DNode, SKAudioNode, SKLabelNode, SKNode, SKShapeNode, SKSpriteNode, ShufflePuck, TipNode;

@interface BeerScene : GameScene
{
    _Bool conv;
...
@property(retain) BeerView *scene3d; // @synthesize scene3d;
