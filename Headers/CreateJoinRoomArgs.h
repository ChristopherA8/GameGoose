...
+ (id)createJoinRoomArgsWithRoomId:(id)arg1 roomType:(id)arg2 visible:(_Bool)arg3 roomData:(id)arg4 joinData:(id)arg5 isDevRoom:(_Bool)arg6;
...
- (id)initWithRoomId:(id)arg1 roomType:(id)arg2 visible:(_Bool)arg3 roomData:(id)arg4 joinData:(id)arg5 isDevRoom:(_Bool)arg6;
- (void)dealloc;
- (id)init;
