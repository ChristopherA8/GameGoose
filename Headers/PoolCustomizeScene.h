...
@class ActionButton, AvatarNode, MessagesViewController, NSMutableArray, PoolCustomizeItem, SKCropNode, SKLabelNode, SKMultilineLabel, SKNode, SKSpriteNode;

@interface PoolCustomizeScene : SKScene
{
    ...
    _Bool scrolled;
    int selected_buy;
    PoolCustomizeItem *selected_item;
