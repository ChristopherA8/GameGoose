...
@interface DeleteObjectsArgs : NSObject <ProtobufMessage>
{
    int cachedSize;
    int cachedSizeId;
...
+ (id)deleteObjectsArgsWithObjectIds:(id)arg1;
@property(retain) NSMutableArray *objectIds; // @synthesize objectIds;
